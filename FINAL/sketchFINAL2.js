...
// var p = r.polygon(200, 150).fill(30);
// var x = p.vars.x;
// var y = p.vars.y;
// for (var i=0; i<30; i++) {
// 	if (i%2==0) {
// 		x += Rune.random(-150,150)
// 	} else {
// 		y += Rune.random(-150,150)
// 	}
// 	p.lineTo(x, y);
// }
...
// 			console.log('here')
// 			console.log(shapeCopy.vars.x, shapeCopy.vars.y)
// 			shapeCopy.fill(60)
// 		}
// 	}
// }
...
//       shape.stroke(false)
//       // shape.fill('hsv', 300, Rune.random(50), Rune.random(10,30), Rune.random(.3, .7));  
//       shape.fill(Rune.random(175,215), Rune.random(.3,.7))
//       if(p.contains(posX, posY)) {
//       	// shape.fill('hsv', 300, Rune.random(50), Rune.random(80,100), Rune.random(.3, .7));
